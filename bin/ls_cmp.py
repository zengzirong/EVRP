...
# 横轴名称。
ax1.set_xlabel("The minimum W obtained with LS")
# 纵轴名称。
ax1.set_ylabel("The minimum W obtained without LS")
x=np.arange(0,1.01*1e6,1e5)
y=x
plt.plot(x,y,color="red",marker = 'o',ls = ':',label='45° Line')
plt.scatter(result_spp,result_no_spp, color = 'b',cmap='viridis')
