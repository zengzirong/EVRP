...
def readData(instance, t_table):
    ...
    t_table = [0, 30, 90, 180, 540, 570, 690, 750, 840]
...
def calObjFromSolvers(model, mtype, tmlimit):
    print("----Solving----")
    if mtype == 'nlp':
        bonmin_path = 'Users/download/bin/bonmin.exe'
        ...
        ipopt_path = '/Users/jingyi/Downloads/COIN-OR-1.7.4-macosx-x86_64-clang500.2.76/bin/ipopt.exe'
...
if __name__ == "__main__":
    ...
    r, a2, a3, mu, M = 479.1, -18.93, 0.7876, 1, 1507
    ...
    calObjFromSolvers(model, 'nlp', 21600 * 2)  # 6h
